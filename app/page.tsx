  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-background">
      ...
      <section className="container pb-16 px-4">
        ...
        {/* Component Grid - converted to masonry layout with 4 columns */}
        <div className="masonry-grid">
          ...
          <div className="masonry-column">
            ...
            {/* Violet Aura Card */}
            <Card className="border-border/50 bg-gradient-to-br from-primary/20 to-primary/5 mb-3">
              <CardHeader className="pb-3">
          ...
          <div className="masonry-column">
            ...
            <Card className="border-border/50 mb-3">
              ...
              <CardContent className="space-y-4 pb-4">
                ...
                <div className="text-center text-xs text-muted-foreground">4 of 4</div>
              </CardContent>
            </Card>
          ...
          <div className="masonry-column">
            ...
            {/* Processing */}
            <Card className="border-border/50 flex items-center justify-center min-h-[180px] mb-3">
            ...
            {/* Terms Agreement */}
            <Card className="border-primary/50 border-border/50 mb-3">
              <CardHeader className="pb-3">
